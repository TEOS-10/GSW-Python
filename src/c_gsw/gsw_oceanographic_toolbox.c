...
gsw_enthalpy_ice(double t, double p)
{
	...
	double	tau, dzi, g0;
	_DOUBLE_COMPLEX r2, sqtau_t1, sqtau_t2, g;
...
gsw_gibbs_ice (int nt, int np, double t, double p)
{
	...
	_DOUBLE_COMPLEX	r2, r2p, r2pp, g, sqtau_t1, sqtau_t2, tau,
			tau_t1, tau_t2;
...
gsw_gibbs_ice_part_t(double t, double p)
{
	...
	GSW_GIBBS_ICE_COEFFICIENTS;
	double	dzi, tau;
	_DOUBLE_COMPLEX	g, tau_t1, tau_t2, r2;
...
gsw_gibbs_ice_pt0(double pt0)
{
	...
	GSW_GIBBS_ICE_COEFFICIENTS;
	double	tau;
	_DOUBLE_COMPLEX	g, tau_t1, tau_t2;
...
gsw_pot_enthalpy_from_pt_ice(double pt0_ice)
{
	...
	GSW_GIBBS_ICE_COEFFICIENTS;
	double	tau;
	_DOUBLE_COMPLEX	h0_part, sqtau_t1, sqtau_t2;
